...
func (w *Workload) RemoveEtcdMemberForMachine(ctx context.Context, machine *kubekeyv1.Machine) error {
...
func (w *Workload) ForwardEtcdLeadership(ctx context.Context, machine *kubekeyv1.Machine, leaderCandidate *kubekeyv1.Machine) error {
	if machine == nil || machine.Status.NodeRef == nil {
		return nil
	}
