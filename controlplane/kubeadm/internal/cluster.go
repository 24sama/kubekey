...
const (
	// ControlPlaneControllerName defines the controller used when creating clients.
	ControlPlaneControllerName = "controlplane-controller"
)
...
type ManagementCluster interface {
	...
	GetMachinesForCluster(ctx context.Context, cluster *kubekeyv1.Cluster, filters ...collections.Func) (collections.Machines, error)
...
func (m *Management) GetMachinesForCluster(ctx context.Context, cluster *kubekeyv1.Cluster, filters ...collections.Func) (collections.Machines, error) {
...
func (m *Management) GetWorkloadCluster(ctx context.Context, clusterKey client.ObjectKey) (WorkloadCluster, error) {
	...
	restConfig, err := remote.RESTConfig(ctx, ControlPlaneControllerName, m.Client, clusterKey)
	if err != nil {
		return nil, err
	}
