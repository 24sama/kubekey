...
import (
	...
	kubeadmtypes "github.com/kubesphere/kubekey/bootstrap/kubeadm/types"
...
type WorkloadCluster interface {
	...
	UpdateKubeProxyImageInfo(ctx context.Context, kcp *controlplanev1.ControlPlane) error
	UpdateCoreDNS(ctx context.Context, kcp *controlplanev1.ControlPlane, version semver.Version) error
	RemoveEtcdMemberForMachine(ctx context.Context, machine *kubekeyv1.Machine) error
	RemoveMachineFromKubeadmConfigMap(ctx context.Context, machine *kubekeyv1.Machine, version semver.Version) error
	RemoveNodeFromKubeadmConfigMap(ctx context.Context, nodeName string, version semver.Version) error
	ForwardEtcdLeadership(ctx context.Context, machine *kubekeyv1.Machine, leaderCandidate *kubekeyv1.Machine) error
...
func (w *Workload) RemoveMachineFromKubeadmConfigMap(ctx context.Context, machine *kubekeyv1.Machine, version semver.Version) error {
...
func (w *Workload) UpdateKubeProxyImageInfo(ctx context.Context, kcp *controlplanev1.ControlPlane) error {
