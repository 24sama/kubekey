...
const (
	// ControlPlaneFinalizer is the finalizer applied to ControlPlane resources
	// by its managing controller.
	ControlPlaneFinalizer = "controlplane.kubekey.kubesphere.io"

	// SkipCoreDNSAnnotation annotation explicitly skips reconciling CoreDNS if set.
	SkipCoreDNSAnnotation = "controlplane.kubekey.kubesphere.io/skip-coredns"

	// SkipKubeProxyAnnotation annotation explicitly skips reconciling kube-proxy if set.
	SkipKubeProxyAnnotation = "controlplane.kubekey.kubesphere.io/skip-kube-proxy"
	...
	KubeadmClusterConfigurationAnnotation = "controlplane.kubekey.kubesphere.io/kubeadm-cluster-configuration"
)
...
type KubeadmControlPlaneMachines struct {
	...
	// +optional
	ObjectMeta kubekeyv1.ObjectMeta `json:"metadata,omitempty"`
...
func (c *ControlPlane) GetConditions() kubekeyv1.Conditions {
	return c.Status.Conditions
}

// SetConditions sets the conditions on this object.
func (c *ControlPlane) SetConditions(conditions kubekeyv1.Conditions) {
