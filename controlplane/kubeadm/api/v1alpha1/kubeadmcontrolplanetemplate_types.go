...
type KubeadmControlPlaneTemplateSpec struct {
	...
	// Foo is an example field of KubeadmControlPlaneTemplate. Edit kubeadmcontrolplanetemplate_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// KubeadmControlPlaneTemplateStatus defines the observed state of KubeadmControlPlaneTemplate
