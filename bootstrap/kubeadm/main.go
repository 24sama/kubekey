...
import (
	...
	"github.com/kubesphere/kubekey/bootstrap/kubeadm/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cb659ce9.kubekey.kubesphere.io",
	})
	if err != nil {
	...
	if err = (&controllers.KubeadmConfigTemplateReconciler{
