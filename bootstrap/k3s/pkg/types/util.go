...
func MarshalInitServerConfiguration(spec *infrabootstrapv1.K3sConfigSpec, token string) (string, error) {
	...
	serverConfig.KubeSchedulerArgs = append(obj.KubernetesProcesses.KubeSchedulerArgs)
	...
	serverConfig.K3sAgentConfiguration = K3sAgentConfiguration{
		...
		KubeletArgs:              append(obj.Agent.KubernetesAgentProcesses.KubeletArgs),
		KubeProxyArgs:            append(obj.Agent.KubernetesAgentProcesses.KubeProxyArgs),
	}
